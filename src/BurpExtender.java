...
public class BurpExtender implements IBurpExtender, ITab {
	...
	private void setITab() {
		...
		JLabel labelBadExt = new JLabel("Ignore extension");
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
								.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(title)
										.addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
												.addComponent(butScopeOnly).addGap(10, 10, 10).addComponent(butFull))
										.addGap(10, 10, 10)
										.addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
												.addComponent(labelBadExt).addGap(10, 10, 10).addComponent(badExt))
										.addGap(10, 10, 10)
										.addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
												.addComponent(butExtract).addGap(10, 10, 10).addComponent(butClear)
												.addGap(10, 10, 10).addComponent(butRun).addGap(10, 10, 10)
												.addComponent(levelsList))
										.addGap(10, 10, 10)
										.addGroup(layout
												.createSequentialGroup().addGap(10, 10, 10).addComponent(progress))
										.addGap(15, 15, 15)
										.addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
												.addComponent(titleOutput))
										.addGap(10, 10, 10).addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
												.addComponent(scrollPane)))
								.addContainerGap(26, Short.MAX_VALUE)));

		layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(10, 10, 10).addComponent(title).addGap(10, 10, 10)
						.addGroup(layout.createParallelGroup().addComponent(butScopeOnly).addComponent(butFull))
						.addGap(10, 10, 10)
						.addGroup(layout.createParallelGroup().addComponent(labelBadExt).addComponent(badExt))
						.addGap(10, 10, 10)
						.addGroup(layout.createParallelGroup().addComponent(butExtract).addComponent(butClear)
								.addComponent(butRun).addComponent(levelsList))
						.addGap(10, 10, 10).addGroup(layout.createParallelGroup().addComponent(progress))
						.addGap(15, 15, 15).addGroup(layout.createParallelGroup().addComponent(titleOutput))
						.addGap(10, 10, 10).addGroup(layout.createParallelGroup().addComponent(scrollPane))
						.addGap(20, 20, 20)));
	}

	private void printURL() {
		/* Function used when user click on "Extract URL" */
		this.clearLog();
	...
	private void clearLog() {
		/* Function used when user click on "Clear logs" */
		progress.setValue(0);
		outputPane.setText("");
	}

	private void runBFAC() {
		/* Function used when user click on "Run BFAC" or "Stop BFAC" */
		if (isRunning) {
			isRunning = false;
			progress.setValue(0);
	...
	public LinkedHashSet<String> extractSitemap() {
		/* Extract sitemap without anchor nor parameters. Keep only direct files routes (with ext). */
